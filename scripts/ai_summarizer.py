...
def generate_summary_hf(
    ...
    # Keep prompt within reasonable token limits
    short_report = report_text if len(report_text) < 20000 else report_text[:20000]
    input_prompt = (
    ...
    print(f"📦 Loading model: {model_name} (may download the first time)...")
